# This a copy of the contract_address.py library from the Starkware library:
# https://github.com/starkware-libs/cairo-lang/blob/master/src/starkware/starknet/core/os/contract_address/contract_address.py
# We added print statements in calculate_contract_address() function to get the class hash, salt, and constructor calldata
# If you wish to use it, replace your site-packages/starkware/starknet/core/os/contract_address/contract_address.py with this file.
...
def calculate_contract_address(
    ...
    print(f"Salt: {salt}")
    print(f"Constructor calldata: {constructor_calldata}")
